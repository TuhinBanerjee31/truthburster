        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="text-center lg:text-left">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
              Connecting people with <span className="text-[#c18431]">trustworthy</span> and{" "}
              <span className="block mt-2">companies</span>
            </h1>
            <p className="text-gray-600 mb-8 text-base sm:text-lg">
              Truthburster is a modern platform for everyday people,
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="bg-gray-50 p-4 sm:p-6 rounded-lg">
                ...
                <p className="text-sm sm:text-base text-gray-700">
                  "The platform has helped us scale our operations and cut costs
