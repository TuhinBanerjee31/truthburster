          ...
          <div className="px-6 py-8 prose prose-indigo max-w-none">
            ...
            <section className="mb-8">
              <p className="text-gray-700">
                ...
                using our websites, https://www.truthbusters.com,
                https://www.truthbusters.com/business,
                https://biz.truthbusters.com, our software as service called
                Jabio, our mobile app, and AI technology services, hereinafter
                and collectively referred to as the website.
              </p>
            </section>
