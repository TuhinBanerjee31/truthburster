...
const Terms = () => {
  ...
  const sectionsContent: Record<string, string> = {
    Definitions: `Parties: "You" and "your" refer to you, as a user of the Site. A "user" is someone who accesses, browses, crawls, or in any way uses the Site. "We," "us," and "our" refer to truthbusters.

Content: "Content" means text, images, photos, audio, video, and all other forms of data or communication. This includes Your Content, User Content, truthbusters Content, Third Party Content, and Site Content.`,
...
Ownership: You own Your Content. We own the truthbusters Content and IP Rights associated with the Site.`,
...
Copyright Disputes: We follow DMCA guidelines for copyright infringement claims.`,
    ...
    Advertising: `The truthbusters Advertising Agreement applies to business accounts and advertising purchases.`,
    ...
    Indemnity: `You agree to indemnify and hold truthbusters harmless from claims arising from your use of the Site.`,
          ...
          <div className="px-6 py-8 prose prose-indigo max-w-none">
            <section className="mb-8">
              <p className="text-gray-700">
                ...
                and use of truthbusters's websites. By accessing or using the
                Site, you are agreeing to these Terms and concluding a legally
                binding contract with GGL Projects, Inc., a California
                corporation headquartered in Menlo Park, California
                ("truthbusters"). Do not access or use the Site if you are
